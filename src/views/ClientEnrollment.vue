<template>
    <div class="home">
        ...
        <div class="row py-4" id="navSecondBar">
            ...
            <div class="d-flex flex-row mb-3 justify-content-center" id="search"
                style="position: absolute;margin-top: -5px; ">

                <div class="p-2"> <input placeholder="輸入想查找的活動資料" class="form-control" v-model="input" type="text"
                        id="demo">
                </div>
